...
public class GSuiteClientTest extends LastaFluteTestCase {
    ...
    public void testPrivateKey() {
        ...
        params.put(GSuiteClient.PRIVATE_KEY_PARAM, privateKeyPem);
        params.put(GSuiteClient.PRIVATE_KEY_ID_PARAM, "aaa");
        params.put(GSuiteClient.CLIENT_EMAIL_PARAM, "aaa");
        GSuiteClient.RequestInitializer initializer = new GSuiteClient.RequestInitializer(params, null);
        try {
